...
const xpathUser = {
    ...
    quantityInWishlist: "//div[@class=\'wishlist-product\']//div[@class=\'wishlist-product-right\']/p[@class=\'wishlist-product-title\' and contains(text(), \'Mug The best is yet to come\')]/..//p[@class=\'wishlist-product-combinations-text\']/span",
    deleteProdFromWishlist: '//div[1]/button[2]',
    confirmRemoval: '//div[5]/div[1]/div[1]/div[1]/div[3]/button[2]',
}
...
const xpathAdmin = {
    ...
    newQuantityButton: "//div[@class='product-header-summary']/div[@data-role='quantity']/div[contains(@class, 'product-total-quantity')]"
}